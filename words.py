...
# File: words.py
#
# Description: This module defines a list called WORD_LIST containing the
#              five-letter words allowed for the game of Wordle-ish.
#
...
WORD_LIST = [
    ...
    "penna", "penne", "penny", "peons", "peony", "perch", "peeve",
    ...
    "phony", "photo", "pelts", "pence", "piano", "picas", "picks",
    ...
    "ponds", "pomps", "pools", "poons", "poops", "poori", "popes",
    "poppy", "porch", "pored", "pores", "porks", "pongs", "ports",
    ...
    "prays", "preen", "preps", "press", "pooch", "preys", "price",
